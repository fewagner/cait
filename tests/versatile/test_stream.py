...
def test_trigger(stream_cresst):
    i, v = vai.trigger(stream_cresst, "mock_001_Ch0", 0.1, 2**14)
    i, v = vai.trigger(stream_cresst, "mock_001_Ch0", 0.1, 2**14, n_triggers=10)
    i, v = vai.trigger(stream_cresst, "mock_001_Ch1", 0.1, 2**14, preprocessing=lambda x: -x)