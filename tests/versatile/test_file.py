...
class TestEventIterator(unittest.TestCase):
    ...
    def test_iterator_bs1_ch2(self):
        it = vai.file.EventIterator(self.dh.get_filepath(), "events", "event")
        for i in it:
    ...
    def test_iterator_bs10_ch2(self):
        ...
        it = vai.file.EventIterator(self.dh.get_filepath(), "events", "event", batch_size=10)
        for i in it:
    ...
    def test_iterator_bs1_ch1(self):
        it = vai.file.EventIterator(self.dh.get_filepath(), "events", "event", channels=1)
        for i in it:
    ...
    def test_iterator_bs10_ch1(self):
        it = vai.file.EventIterator(self.dh.get_filepath(), "events", "event", channels=1, batch_size=10)
        for i in it:
    ...
    def test_inds(self):
        ...
        it1 = vai.file.EventIterator(self.dh.get_filepath(), "events", "event", inds=inds)
        it2 = vai.file.EventIterator(self.dh.get_filepath(), "events", "event", channels=1, inds=inds)
        it3 = vai.file.EventIterator(self.dh.get_filepath(), "events", "event", channels=1, batch_size=3, inds=inds)
        it4 = vai.file.EventIterator(self.dh.get_filepath(), "events", "event", batch_size=3, inds=inds)
    ...
    def test_batch_remainder(self):
        it = vai.file.EventIterator(self.dh.get_filepath(), "events", "event", channels=1, batch_size=11)
