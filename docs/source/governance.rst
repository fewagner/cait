...
used by the Cait project in both ordinary and extraordinary
...
Cait is a community-owned and community-run project. To the maximum
...
members of the community additionally contribute by serving on the Cait
...
The Cait Project (The Project) is an open source software project. The goal of The Project
is to develop open source software for the data analysis of cryogenic rare event search experiments in Python,
and in particular the ``cait`` package. The Software developed
by The Project is released under the GLPv3 (or similar) open source
license and hosted on Git repositories.
...
and discussing Git Pull Requests and Issues and participating in Project discussions. The foundation of Project participation is openness and
transparency.
...
bug fix reviewed by a core developer is probably
fine) and best efforts (e.g., all substantive API changes must be forwarded to the broader community to give a chance to
catch any problems and suggest improvements; we assume that anyone who
cares enough about The Project to invoke their veto right should be included in such feedback loops). If no-one bothers to comment on the feedback request after a
...
quality and quantity, and sustained over at least six months. The overall
...
substantial in quality and quantity, and sustained over at least six months.
Potential Council Members are nominated by existing Council
...
early 2021, have been significantly active over the last six months.
...
is not limited to code, code review, infrastructure work, chat participation, community help/building, education and outreach,
...
If a Council member becomes inactive in the project for a period of six months, they will be considered for removal from the Council. Before
...
participation soon, they will be given a grace period of six months. If
...
members will be listed on the project website.
...
Project Contributors and Community. When private communications and decisions are
...
contributing employees, then six months grace period commence. If at
the end of six months period they continue not to have any
...
override the Steering Council. If a Partner has funding to do work on The Project
...
that part of the Partner’s work will not be under the umbrella of The Project and
cannot use the Project trademarks in a way that suggests a formal
relationship.

Institutional Partner benefits are:

-  Acknowledgement on the Cait websites and in talks.
-  Ability to acknowledge their own funding sources on the Cait
   websites and in talks.
-  Ability to influence the project through the participation of their
   Council Member.
-  Council Members invited to Cait Developer Meetings.
...
https://github.com/fewagner/cait

Acknowledgements
================

Substantial portions of this document were adapted from the
`Jupyter/IPython project's governance document <https://github.com/jupyter/governance>`_, the `NumPy project's governance document <https://github.com/numpy/numpy/blob/main/doc/source/dev/governance/governance.rst>`_ and the `SciPy project's governance document <https://github.com/scipy/scipy/commits/master/doc/source/dev/governance/governance.rst>`_

License
=======

To the extent possible under law, the authors have waived all
copyright and related or neighboring rights to the Cait project
